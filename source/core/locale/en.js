...
gca_languages["en"] = {
	...
	locale : {
		...
		arena : {
			...
			global_arena_notice : "To track your leaderboard ranking, Global Arena sends your public player information (player name, guild, level and server) to an external service. No data is being collected.",
